...
TEST(TWCoinTypeConfiguration, TWCoinTypeConfigurationGetSymbol) {
    ...
    auto value20 = WRAPS(TWCoinTypeConfigurationGetSymbol(TWCoinTypeStellar));
    assertStringsEqual(value20, "XLM");
}
...
TEST(TWCoinTypeConfiguration, TWCoinTypeConfigurationGetID) {
    ...
    auto value20 = WRAPS(TWCoinTypeConfigurationGetID(TWCoinTypeStellar));
    assertStringsEqual(value20, "stellar");
}
...
TEST(TWCoinTypeConfiguration, TWCoinTypeConfigurationGetName) {
    ...
    auto value20 = WRAPS(TWCoinTypeConfigurationGetName(TWCoinTypeStellar));
    assertStringsEqual(value20, "Stellar");
}